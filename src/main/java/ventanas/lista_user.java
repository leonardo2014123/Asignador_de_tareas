    ...
    /**
     * Panel que gestiona y muestra una lista de usuarios en una tabla.
     * Permite a los administradores visualizar y gestionar todos los usuarios,
     * mientras que los usuarios normales solo pueden ver su propia información.
     */
    public class lista_user extends javax.swing.JPanel {
        ...
        /**
         * Constructor de la clase lista_user.
         * Inicializa el panel con los datos del usuario y carga los usuarios en la tabla.
         *
         * @param nombreUsuario Nombre del usuario que accede al panel.
         * @param tipoUsuario Tipo de usuario ("ADMINISTRADOR" o "NORMAL").
         */
        public lista_user(String nombreUsuario, String tipoUsuario) {
            ...
            cargarUsuariosEnTabla("usuarios.txt");

            // Agregar un listener al combo box para aplicar el filtro
            jComboBoxUsuarios.addActionListener(e -> aplicarFiltro());
        }

        /**
         * Carga los usuarios en la tabla dependiendo del tipo de usuario (administrador o normal).
         *
         * @param archivoUsuarios Nombre del archivo que contiene los datos de los usuarios.
         */
        private void cargarUsuariosEnTabla(String archivoUsuarios) {
        ...
        /**
         * Carga todos los usuarios disponibles para los administradores.
         */
        private void cargarUsuariosAdmin() {
            usuarios = userManager.obtenerTodosLosUsuarios(); // Método para obtener todos los usuarios
            actualizarTablaUsuarios();
            cargarUsuariosComboBox();
        }

        /**
         * Carga la información del usuario normal y la añade a la tabla.
         */
        private void cargarUsuarioNormal() {
            usuarios = new ArrayList<>();
            usuarios.add(userManager.obtenerUsuarioPorNombre(nombreUsuario)); // Solo el usuario actual
            actualizarTablaUsuarios();
            bloquearComboUsuarios();
        }

        /**
         * Carga los nombres de los usuarios en el combo box para aplicar filtros.
         */
        private void cargarUsuariosComboBox() {
            List<String> usuariosList = new ArrayList<>();
            for (User user : usuarios) {
                usuariosList.add(user.getUsuario());
            }
        ...
        /**
         * Actualiza la tabla con la información de los usuarios cargados.
         */
        ...
        /**
         * Aplica un filtro a la lista de usuarios basado en la selección del combo box.
         */
        private void aplicarFiltro() {
            String filtro = (String) jComboBoxUsuarios.getSelectedItem();
            List<User> usuariosFiltrados = new ArrayList<>();

            if ("Todos".equals(filtro)) {
                usuariosFiltrados = userManager.obtenerTodosLosUsuarios();
            } else {
                // Filtrar por nombre de usuario
                usuariosFiltrados.add(userManager.obtenerUsuarioPorNombre(filtro));
            }
        ...
        /**
         * Clase personalizada para manejar los botones de acción (editar y eliminar) en la tabla.
         */
        class AccionRendererEditor extends AbstractCellEditor implements TableCellRenderer, TableCellEditor {
            ...
            /**
             * Constructor que inicializa los botones de acción y sus eventos.
             */
            public AccionRendererEditor() {
                ...
                btnEditar.addActionListener(e -> {
                    ...
                    if (row != -1) {
                        ...
                        new editar_user(usuarioSeleccionado, nombreUsuario);
                    } else {
                ...
                btnEliminar.addActionListener(e -> {
                    ...
                    if (row != -1) {
                        ...
                        if (confirm == JOptionPane.YES_OPTION) {
                            eliminarTareasDelUsuario(usuarioSeleccionado);
                            usuarios.remove(usuarioSeleccionado);
                            actualizarTablaUsuarios();

                            userManager.guardarUsuariosEnArchivo("usuarios.txt", usuarios, tipoUsuario);
                            tareaManager.guardarTareasEnArchivo("tareas.txt", tareaManager.obtenerTodasLasTareas(), tipoUsuario, nombreUsuario);

                            JOptionPane.showMessageDialog(panel,
                                "El usuario y sus tareas han sido eliminados correctamente.",
                                "Éxito",
        ...
        /**
         * Elimina todas las tareas asociadas a un usuario específico.
         *
         * @param usuario El usuario cuyas tareas deben ser eliminadas.
         */
        private void eliminarTareasDelUsuario(User usuario) {
            List<Tarea> tareas = tareaManager.obtenerTodasLasTareas(); // Obtener todas las tareas
            tareas.removeIf(t -> t.getUsuario().equals(usuario.getUsuario())); // Eliminar las tareas asignadas a este usuario
            tareaManager.guardarTareasEnArchivo("tareas.txt", tareas, tipoUsuario, nombreUsuario); // Guardar las tareas actualizadas
        }
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(13, 13, 13))
                    .addComponent(jSeparator2, javax.swing.GroupLayout.DEFAULT_SIZE, 656, Short.MAX_VALUE)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(jLabel5)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jComboBoxUsuarios, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(4, 4, 4))
        );
